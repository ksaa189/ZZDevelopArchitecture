...
{
    return [ZZCommon rangeArrayOfString:str pointStart:iStart start:strStart end:strEnd mark:strMark operation:operation everyStringExecuteBlock:nil];
}
...
+ (NSString *)getValueInANonAttributeXMLNode:(NSString *)str key:(NSString *)akey location:(int)location{
    ...
    if (ZZCommon_lastLocation == location)
    {
    ...
    NSRange range = [ZZCommon rangeOfString:str pointStart:i start:str1 end:str2 mark:str1 operation:MarkOption_middle];
#pragma mark- 待优化
    if (0 == range.length)
    {
        i = 0;
        range = [ZZCommon rangeOfString:str pointStart:i start:str1 end:str2 mark:str1 operation:MarkOption_middle];
    }
