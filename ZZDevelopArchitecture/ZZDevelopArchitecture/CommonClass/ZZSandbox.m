...
@implementation ZZSandbox __DEF_SINGLETON
...
+ (NSString *)appPath
{
    return [[ZZSandbox sharedInstance] appPath];
}
...
+ (NSString *)docPath
{
    return [[ZZSandbox sharedInstance] docPath];
}
...
{
    return [[ZZSandbox sharedInstance] libPrefPath];
}
...
{
    return [[ZZSandbox sharedInstance] libCachePath];
}
...
+ (NSString *)tmpPath
{
    return [[ZZSandbox sharedInstance] tmpPath];
}
...
+ (NSString *)resPath:(NSString *)file{
    return [[ZZSandbox sharedInstance] resPath:file];
}
...
{
    return [[ZZSandbox sharedInstance] touch:path];
}
...
{
    return [[ZZSandbox sharedInstance] touchFile:file];
}
