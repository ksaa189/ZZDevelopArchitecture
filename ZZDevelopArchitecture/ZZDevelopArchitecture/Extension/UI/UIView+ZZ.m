...
/*
 ...
 ZZ_swizzleInstanceMethod([self class], @selector(UIView_dealloc), @selector(dealloc));
	[self dealloc];
 }
 */
...
+ (void)load
{
    ...
    NSDate *timeOut = [ZZCommon getDateFromString:__TimeOut__date__];
...
- (void)animationShake
{
    ...
    shake.repeatCount  = 3;
    [self.layer addAnimation:shake forKey:@"ZZShake"];
}
