...
#import "ZZViewControllerManager.h"
#import "UIView+ZZ.h"

@interface ZZViewControllerManager ()
@property (nonatomic, strong, readonly) NSMutableDictionary *viewControllerSetupBlocks; // 创建viewControllers的block
@end

@implementation ZZViewControllerManager __DEF_SINGLETON
...
{
    UIViewController *targetViewController = (_viewControllers[key]) ? _viewControllers[key] : ((ZZViewControllerManager_createVC_block)_viewControllerSetupBlocks[key])();
...
@implementation UIViewController (ZZViewControllerManager)

- (ZZViewControllerManager *)uZZ_viewControllerManager
{
    return [ZZViewControllerManager sharedInstance];
}
